...
import { idlFactory } from './storage_canister_1.did.js';
export { idlFactory } from './storage_canister_1.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_STORAGE_CANISTER_1;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./storage_canister_1.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the storage_canister_1 canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./storage_canister_1.did.js")._SERVICE>}
 */
export const storage_canister_1 = createActor(canisterId);

...
import { idlFactory } from './origyn_nft_reference_prod.did.js';
export { idlFactory } from './origyn_nft_reference_prod.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ORIGYN_NFT_REFERENCE_PROD;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./origyn_nft_reference_prod.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the origyn_nft_reference_prod canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./origyn_nft_reference_prod.did.js")._SERVICE>}
 */
export const origyn_nft_reference_prod = createActor(canisterId);
